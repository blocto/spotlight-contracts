...
contract SpotlightUSDCBondingCureve is ISpotlightBondingCurve {
        ...
        returns (uint256 baseTokensOut)
    {
        ...
        // adjust for 12 decimal places difference between deltaY and baseTokensOut
        baseTokensOut = deltaY / (10 ** 12);
    }
        ...
        returns (uint256 targetTokensOut)
    {
        ...
        uint256 deltaY = basedTokensIn * 10 ** 12;
