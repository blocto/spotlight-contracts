...
contract SpotlightBondingCurveTest is Test {
    ...
    function setUp() public {
        _bondingCurve = new SpotlightUSDCBondingCurve(1060848709, 4379701787);
    }

    function testGetBaseTokenBuyQuote_0() public view {
        uint256 currentSupply = 0;
        uint256 baseTokensIn = 100_000; // 0.1 USDC
    ...
    function testGetBaseTokenBuyQuote_1() public view {
        ...
        uint256 baseTokensIn = 500_000_000; // 500 USDC
    ...
    function testGetTargetTokenSellQuote_1() public {
        ...
        vm.expectRevert("SpotlightUSDCBondingCureve: INSUFFICIENT_SUPPLY");
